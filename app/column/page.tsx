...
const columns = [
  {
    id: 1,
    title:
      "【介護現場の負担を解消】書類作成時間を60%以上削減するCare Smilyの全貌",
      ...
      <div className="container mx-auto px-4 py-8">
            ...
            >
              ...
              <div className="relative overflow-hidden" style={{ aspectRatio: '16/9' }}>
                ...
                <div className="absolute top-4 left-4 z-10">
                  <Badge
                    className={`${column.categoryColor} text-white px-3 py-1 text-sm font-medium shadow-lg`}
                  >
                    ...
                    <div className="bg-white/90 backdrop-blur-sm rounded-lg px-3 py-2">
                      <div className="flex items-center text-gray-800">
                        <span className="text-lg font-bold">
                          {column.dateRange.split("～")[0]}
                        </span>
                        <span className="mx-2">～</span>
                        <span className="text-lg font-bold">
                          {column.dateRange.split("～")[1]}
                        </span>
        ...
        {totalPages > 1 && (
          <div className="text-center mt-4 text-sm text-gray-500">
            {filteredColumns.length}件中 {startIndex + 1}-
            {Math.min(startIndex + itemsPerPage, filteredColumns.length)}
