...
export default function FAQSection() {
  ...
  return (
    <section ref={sectionRef} className="w-full py-16 bg-[#8dd9fa] overflow-hidden relative">
      {/* タイトル部分 - FAQが並ぶデザイン */}
          ...
          {Array.from({ length: 10 }).map((_, index) => (
            <span
              ...
              className={`text-4xl md:text-5xl font-bold mx-2 ${
                index % 2 === 0 ? "font-serif italic text-[#1a2b4a]/70" : "text-[#1a2b4a]"
              }`}
            >
              ...
              <div className="flex items-start faq-question">
                ...
                <div className="flex-1 bg-white rounded-2xl p-6 shadow-md relative">
                  ...
                  <div className="flex items-center mb-2">
                    <span className="text-2xl font-bold text-[#1a2b4a] mr-4">Q</span>
                    <p className="text-[#1a2b4a] font-medium">{item.question}</p>
                  </div>
                </div>
              </div>
