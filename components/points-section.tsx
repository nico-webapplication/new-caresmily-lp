      ...
      <div className="container mx-auto px-8 md:px-20 py-16 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="lg:w-1/2 bg-white rounded-lg shadow-lg p-6">
            ...
            <textarea
              ref={textAreaRef}
              className="w-full h-96 p-4 border border-gray-300 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-[#42a5d5] focus:border-transparent"
              placeholder="ここにメモやコメントを入力してください..."
            />
            <div className="mt-4 flex justify-end">
              <Button className="bg-[#42a5d5] hover:bg-[#3694c4] text-white">
                保存
              </Button>
            </div>
          </div>
